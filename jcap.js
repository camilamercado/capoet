...
//document.write("<p id=\"enter\"><input type=\"text\" id=\"" + jfldid + "\" name=\"" + jfldid + "\" class=\"" + jfldcls + "\" size=\"" +  jfldsz + "\"><\/p>");
document.write("<p id=\"word\"><img id=\"captcha\"src=\"" + decodeURIComponent(imgdir) + imgid + ".jpg\" width=\"290\" height=\"80\" alt=\"\"><\/p>");
...
// 	//$( "#enter" ).empty();
// 	//document.write("<p id=\"enter\"><input type=\"text\" id=\"\" name=\"\" class=\"\"><\/p>");
